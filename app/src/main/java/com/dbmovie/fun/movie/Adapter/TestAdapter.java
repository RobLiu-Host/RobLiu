 ...
 * Created on 16/7/12.
 */
public class TestAdapter extends RecyclerViewCommonAdapter<Top250Bean.SubjectsBean> {
    /**
     * @param mContext 上下文对象
     * @param list     数据List
     */
    public TestAdapter(Context mContext, List<Top250Bean.SubjectsBean> list) {
